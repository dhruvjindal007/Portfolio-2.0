    ...
    <section className={`py-20 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <div
            className={`w-20 h-1 mx-auto rounded ${isDark ? 'bg-cyan-400' : 'bg-blue-500'}`}
          />
          <p
            className={`mt-6 text-lg max-w-3xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}
          >
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className={`text-lg font-bold mb-3 leading-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  {post.title}
                </h3>
